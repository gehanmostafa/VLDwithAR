...
// import usePostRoomImage from '@/hooks/Room/usePostRoomImage';


// const StartDesign = () => {
//   const router = useRouter();
//   const { mutate } = usePostRoomImage();
...
//       {
//         onSuccess: (response) => {
//           const modelUrl = response.modelUrl; // تأكدي من اسم المفتاح اللي الـ AI بيرجعه
//           if (modelUrl) {
//             localStorage.setItem("modelSrc", modelUrl);
//             router.push("/arPage");
//           } else {
//             alert("❌ Failed to get 3D model from AI");
//           }
//         },
//         onError: (err) => {
