...
export default function Navbar() {
  ...
  return (
    <nav className="bg-mainbackground py-4 px-4 md:px-36 relative z-20 shadow-md">
      ...
      {/* Mobile Menu */}
      {isOpen && (
        <div className="md:hidden mt-4 bg-mainbackground px-4 py-4 space-y-2 rounded-b-lg shadow-lg animate-slideDown">
          {navItems.map(({ href, label }) => (
            <Link key={href} href={href}>
              <span
