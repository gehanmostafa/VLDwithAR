...
// const HomeContent = () => {
//   return (
//     <main className="bg-[#003F63] font-sans text-white">
//       {/* ---------- Hero Section ---------- */}
//       <section className="relative">
//         <div className="w-full h-[300px] sm:h-[400px] md:h-[500px] overflow-hidden">
//           <video
...
//             {/* Start Now Button */}
//             <div className="flex justify-center">
//               <button className="group relative flex items-center gap-3 bg-white text-[#003F63] px-6 sm:px-8 py-2 sm:py-3 rounded-full font-semibold transition-all duration-300 hover:pl-10 hover:shadow-md">
//                 <span className="transition-all duration-300">Start Now!</span>
//                 <span className="text-xl transition-transform duration-300 group-hover:translate-x-1">
//                   ➜
//                 </span>
...
//       {/* ---------- Reasons Section ---------- */}
//       <section className="py-14 px-4 sm:px-6 md:px-10 bg-[#003F63] text-white">
//         <div className="max-w-6xl mx-auto grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-8">
//           <h2 className="text-2xl sm:text-3xl font-bold mb-6 col-span-full">
//             Reasons to choose Wardiere Inc.
//           </h2>
...
//             <div
//               key={i}
//               className="bg-[#E5F2F8] text-[#003F63] px-6 py-8 rounded-xl transition-transform duration-300 transform hover:scale-[1.03] hover:shadow-xl h-full"
//             >
//               <p className="font-semibold text-sm mb-2">{tag}</p>
//               <h3 className="font-bold text-lg mb-1">{title}</h3>
//               <p className="text-sm">{text}</p>
...
//       {/* ---------- Testimonial Section ---------- */}
//       <section className="bg-[#003F63] py-16 px-4 sm:px-6">
//         <div className="bg-[#E5F2F8] max-w-6xl mx-auto rounded-xl px-4 sm:px-6 py-10 sm:py-12">
//           <h2 className="text-xl sm:text-2xl font-bold text-[#003F63] text-center mb-10">Customer Testimonial</h2>
...
//               <div
//                 key={i}
//                 className="bg-[#003F63] text-white rounded-xl p-6 min-h-[300px] flex flex-col justify-between shadow-lg hover:scale-105 transition-transform duration-300"
//               >
//                 <div>
//                   <div className="text-3xl text-white mb-2">“</div>
//                   <p className="text-lg font-bold">{comment}</p>
...
//       {/* ---------- Contact Section with Main Color Card ---------- */}
//       <section className="bg-[#003F63] py-16 px-4">
//         <div className="bg-[#E5F2F8] max-w-6xl mx-auto rounded-xl px-4 sm:px-6 py-12">
//           <h2 className="text-[#003F63] text-lg sm:text-xl font-bold mb-10 flex items-center gap-2">
//             <span className="w-4 h-4 bg-[#003F63] rounded-sm"></span>
//             Contact Us
//           </h2>
...
//             {/* 💚 Contact Card with Main Color */}
//             <div className="relative w-full max-w-md mx-auto bg-[#003F63] rounded-2xl p-6 sm:p-8 text-white shadow-2xl space-y-5 border border-[#ffffff22] flex flex-col items-center justify-center h-[340px]">
//               <div className="text-center space-y-4">
//                 <h3 className="text-lg font-semibold">Let's get in touch</h3>
//                 {[ 
//                   { icon: '📞', text: '2834-45-75' },
