...
//         <div className="flex items-center gap-2 bg-[#0D4C3E] text-white px-4 py-2 rounded-md cursor-pointer">
//           <FaPlus />
//           <span>Add New</span>
//         </div>
...
//   const handleAddNew = () => {
//     router.push("/uploadIMG"); // ✅ Navigate to /uploadIMG
//   };
...
//           onClick={handleAddNew} // ✅ Add onClick handler
//         >
//           <FaPlus />
//           <span>Add New</span>
//         </div>
